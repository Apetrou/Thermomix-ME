...
<div class="container" style="margin-top:40px;">
    <div class="login-container">
        ...
        <div class="message">Please choose a new password for your Account</div>
        <form id="reset_password">
            <label for="activate_password">Password</label>
            <input type="password" name="activate_password" id="activate_password" class="form-control form-spacer"/>
            ...
            <input type="hidden" name="identifier" value="<?=$_GET['ref']?>"/> 
        </form>
            <div class="login-button-container pull-right">
                <button class="btn btn-default btn-md reset-password"><span class="glyphicon glyphicon-refresh" style="margin-right:5px;"></span> Reset Password</button>
            </div>
